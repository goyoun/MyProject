...
<h1 class="text-center" style="margin-top:25px"> 여행게시판 글쓰기 페이지 </h1>

<form action="tripSavefile" method="post" enctype="multipart/form-data">

<div class="container mt-5" style="width:60%; height:500px; background-color: #f5f5f5; border-radius: 1rem;">
