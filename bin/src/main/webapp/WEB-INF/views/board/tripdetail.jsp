...
<span class="badge rounded-pill bg-dark fs-6">글쓴이 : ${board.b_writer}</span>
	...
	<c:when test="${sessionScope.loginId eq board.b_writer}">
  		...
  		<button type="button" class="neon-button1" onclick="location.href='/board/paging?page=${page}'"> 글목록 </button>
  		<button type="button" class="neon-button2" onclick="location.href='/board/update?b_number=${board.b_number}&page=${page}'"> 수정 </button>
  		<button type="button" class="neon-button3" onclick="location.href='/board/delete?b_number=${board.b_number}'"> 삭제 </button>
  	</c:when>
...
<br>
	<img class="rounded mx-auto d-block mt-3" alt="" src="/resources/tripimage/${board.b_filename}" width="400" height="400"> <br>   
</div>

	<!-- 내용 -->
	<div class="form-floating text-center">
  <textarea style = "height:200px; width:70%;"  readonly>${board.b_contents} </textarea>
 </div>
<br>
...
<textarea id="c_contents" class="form-control" id="floatingTextarea2" style="height: 95px"></textarea>
