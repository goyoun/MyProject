...
<form action="/board/updatec" method="POST" name="update_formc" enctype="multipart/form-data">

<div class="container mt-5" style="width:40%; height:500px; background-color: #f5f5f5; border-radius: 3rem;">
	<div class = "row">
	<h2 class="text-center" style="margin-top:25px"> Cook Update </h2>
	</div>
	
	<input type="hidden" name="m_number" value="${board.m_number}">
	<input type="hidden" name="pagec" value="${pagec}"> <br>
    ...
    <input type="file" name="b_file" class="">
